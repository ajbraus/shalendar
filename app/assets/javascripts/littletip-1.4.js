 ...
 */
	...
	littleTIPy				=   -40     ;	// Vertical distance from cursor (in pixels)
...
$(document).ready(function(){			// Script executed on DOM load
	...
	elT.mouseover(function(e){					// Function applied to title attribute on mouse over
		...
		$('#littleTIP').delay(littleTIPdelay).fadeIn(littleTIPfade).css({		// Delay, fade and littleTIP wrapper css properties
			...
			width: 'auto',
			height: 'auto',
			top: e.pageY + littleTIPy,
			left: e.pageX + littleTIPx
		});
