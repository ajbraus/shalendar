...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_development_dependency(%q<webmock>, ["~> 1.8.3"])
      s.add_development_dependency(%q<faraday>, ["~> 0.8"])
      s.add_development_dependency(%q<httpclient>, ["~> 2.2"])
      s.add_development_dependency(%q<excon>, ["< 1.0", ">= 0.11.0"])
      ...
      s.add_development_dependency(%q<typhoeus>, ["< 0.5.0", ">= 0.3.3"])
      ...
      s.add_dependency(%q<webmock>, ["~> 1.8.3"])
      s.add_dependency(%q<faraday>, ["~> 0.8"])
      s.add_dependency(%q<httpclient>, ["~> 2.2"])
      s.add_dependency(%q<excon>, ["< 1.0", ">= 0.11.0"])
      ...
      s.add_dependency(%q<typhoeus>, ["< 0.5.0", ">= 0.3.3"])
