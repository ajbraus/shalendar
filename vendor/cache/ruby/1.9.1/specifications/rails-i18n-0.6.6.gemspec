...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_development_dependency(%q<i18n-spec>, [">= 0.2.2"])
      s.add_development_dependency(%q<spork>, ["= 1.0.0rc2"])
    else
      s.add_dependency(%q<i18n>, ["~> 0.5"])
      s.add_dependency(%q<rails>, [">= 3.0.0"])
      s.add_dependency(%q<rspec-rails>, [">= 2.7.0"])
      s.add_dependency(%q<i18n-spec>, [">= 0.2.2"])
      s.add_dependency(%q<spork>, ["= 1.0.0rc2"])
    end
  else
    s.add_dependency(%q<i18n>, ["~> 0.5"])
    s.add_dependency(%q<rails>, [">= 3.0.0"])
